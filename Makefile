CC = gcc
CFLAGS = -std=c11 -Ofast -march=native -funroll-loops -Wall -Wextra -lm
...
37: problem_026-050/problem_037.c
	$(CC) problem_026-050/problem_037.c -o bin_037 $(CFLAGS)
38: problem_026-050/problem_038.c
	$(CC) problem_026-050/problem_038.c -o bin_038 $(CFLAGS)
39: problem_026-050/problem_039.c
	$(CC) problem_026-050/problem_039.c -o bin_039 $(CFLAGS)
40: problem_026-050/problem_040.c
	$(CC) problem_026-050/problem_040.c -o bin_040 $(CFLAGS)
41: problem_026-050/problem_041.c
	$(CC) problem_026-050/problem_041.c -o bin_041 $(CFLAGS)
42: problem_026-050/problem_042.c
	$(CC) problem_026-050/problem_042.c -o bin_042 $(CFLAGS)
43: problem_026-050/problem_043.c
	$(CC) problem_026-050/problem_043.c -o bin_043 $(CFLAGS)
44: problem_026-050/problem_044.c
	$(CC) problem_026-050/problem_044.c -o bin_044 $(CFLAGS)
45: problem_026-050/problem_045.c
	$(CC) problem_026-050/problem_045.c -o bin_045 $(CFLAGS)
46: problem_026-050/problem_046.c
	$(CC) problem_026-050/problem_046.c -o bin_046 $(CFLAGS)
47: problem_026-050/problem_047.c
	$(CC) problem_026-050/problem_047.c -o bin_047 $(CFLAGS)
48: problem_026-050/problem_048.c
	$(CC) problem_026-050/problem_048.c -o bin_048 $(CFLAGS)
49: problem_026-050/problem_049.c
	$(CC) problem_026-050/problem_049.c -o bin_049 $(CFLAGS)
50: problem_026-050/problem_050.c
	$(CC) problem_026-050/problem_050.c -o bin_050 $(CFLAGS)
51: problem_051-075/problem_051.c
	$(CC) problem_051-075/problem_051.c -o bin_051 $(CFLAGS)
52: problem_051-075/problem_052.c
	$(CC) problem_051-075/problem_052.c -o bin_052 $(CFLAGS)
53: problem_051-075/problem_053.c
	$(CC) problem_051-075/problem_053.c -o bin_053 $(CFLAGS)
54: problem_051-075/problem_054.c
	$(CC) problem_051-075/problem_054.c -o bin_054 $(CFLAGS)
55: problem_051-075/problem_055.c
	$(CC) problem_051-075/problem_055.c -o bin_055 $(CFLAGS)
56: problem_051-075/problem_056.c
...
59: problem_051-075/problem_059.c
	$(CC) problem_051-075/problem_059.c -o bin_059 $(CFLAGS)
60: problem_051-075/problem_060.c
	$(CC) problem_051-075/problem_060.c -o bin_060 $(CFLAGS)
61: problem_051-075/problem_061.c
	$(CC) problem_051-075/problem_061.c -o bin_061 $(CFLAGS)
62: problem_051-075/problem_062.c
	$(CC) problem_051-075/problem_062.c -o bin_062 $(CFLAGS)
63: problem_051-075/problem_063.c
	$(CC) problem_051-075/problem_063.c -o bin_063 $(CFLAGS)
65: problem_051-075/problem_065.c
	$(CC) problem_051-075/problem_065.c -o bin_065 $(CFLAGS)
67: problem_051-075/problem_067.c
	$(CC) problem_051-075/problem_067.c -o bin_067 $(CFLAGS)
69: problem_051-075/problem_069.c
	$(CC) problem_051-075/problem_069.c -o bin_069 $(CFLAGS)
76: problem_076-100/problem_076.c
	$(CC) problem_076-100/problem_076.c -o bin_076 $(CFLAGS)
78: problem_076-100/problem_078.c
	$(CC) problem_076-100/problem_078.c -o bin_078 $(CFLAGS)
79: problem_076-100/problem_079.c
	$(CC) problem_076-100/problem_079.c -o bin_079 $(CFLAGS)
81: problem_076-100/problem_081.c
	$(CC) problem_076-100/problem_081.c -o bin_081 $(CFLAGS)
92: problem_076-100/problem_092.c
	$(CC) problem_076-100/problem_092.c -o bin_092 $(CFLAGS)
97: problem_076-100/problem_097.c
	$(CC) problem_076-100/problem_097.c -o bin_097 $(CFLAGS)
99: problem_076-100/problem_099.c
	$(CC) problem_076-100/problem_099.c -o bin_099 $(CFLAGS)
206: problem_201-225/problem_206.c
	$(CC) problem_201-225/problem_206.c -o bin_206 $(CFLAGS)
